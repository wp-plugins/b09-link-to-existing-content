/* 
*	global ajaxurl, tinymce, linkToExistingContent, setUserSetting, wpActiveEditor 
*
...
( function( $ ) {
	var editor, searchTimer, River, Query, correctedURL,
		...
		wpLinkL10n = linkToExistingContent.wpLinkL10n;
	...
	ltecWpLink = {
		...
		init : function() {
			...
			var $searchInWrap = $("<label id='ltec-search-in'></label>")
				.append( $("<span class='search-label'>").text(wpLinkL10n.searchIn) )
				.append("<select id='ltec-search-select' class='link-search-field'></select>");
			
			$searchWrap.after( $searchInWrap ); 

			//$searchWrap.clone().appendTo("#search-panel .link-search-wrapper").attr("id", "ltec-search-in").find(".link-search-field").remove();
